    ...
    topics: [
      {
        ...
        lesson: {
          ...
          exercises: [
            "ถ้า A = {x | x เป็นจำนวนคี่บวกที่น้อยกว่า 10} จงเขียน A แบบแจกแจงสมาชิก",
            "กำหนด n(A) = 12, n(B) = 9, n(A ∩ B) = 4 จงหา n(A ∪ B)",
            "จงหาจำนวนสับเซตทั้งหมดของเซต {a, b, c, d, e}",
          ]
        }
      },
    ...
    topics: [
      {
        ...
        lesson: {
          ...
          exercises: [
            "ถ้า cos θ = 5/13 และ θ อยู่ในควอดรันต์ที่ 4 จงหา sin θ และ tan θ",
            "สามเหลี่ยม ABC มีมุม A = 40°, มุม B = 60°, ด้าน a = 10 จงหาด้าน b ด้วยกฎของไซน์",
            "จงพิสูจน์เอกลักษณ์ (1 − cos²θ) / sinθ = sinθ",
          ]
        }
      },
    ...
    topics: [
      {
        ...
        lesson: {
          ...
          exercises: [
            "จงหาอนุพันธ์ของ f(x) = (2x + 1)(x − 3)",
            "จงหาจุดสูงสุด-ต่ำสุดของ f(x) = x³ − 3x² + 2",
            "จงหาค่า ∫₀² (3x² − 4x + 1) dx",
          ]
        }
      },
